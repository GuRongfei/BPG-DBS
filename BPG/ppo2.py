...
class PPO2(ActorCriticRLModel):
        ...
        with SetVerbosity(self.verbose):
            ...
            with self.graph.as_default():
                ...
                with tf.variable_scope("loss", reuse=False):
                    ...
                    self.mean = train_model.proba_distribution.mean
                ...
                self.tst1 = train_model.proba_distribution.mean
    ...
    def _train_step(self, learning_rate, cliprange, obs, returns, masks, actions, values, neglogpacs, update,
        ...
        if writer is not None:
            ...
            policy_loss, value_loss, policy_entropy, approxkl, clipfrac, _, mean, std = self.sess.run(
                [self.pg_loss, self.vf_loss, self.entropy, self.approxkl, self.clipfrac, self._train, self.mean, self.std], td_map)
