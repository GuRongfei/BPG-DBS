...
from BPG.policy_debug import MlpPolicy
...
returns = model.returns_log
true_rewards = model.true_rewards_log
print(returns)
...
plot_reward(returns, 'returns')
plot_reward(true_rewards, 'true_rewards')
